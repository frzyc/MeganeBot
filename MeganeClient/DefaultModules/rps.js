...
var rpslslist = rpslist.concat(["Lizard", "Spock"])
var rpslssbwglist = rpslslist.concat(["Spiderman", "Batman", "wizard", "Glock"])
var rpsDB = {}
...
function addrpsoutcome(list,val1, val2, formatstr) {
    let v1 = getfromrpslist(list,val1)
    let v2 = getfromrpslist(list, val2)
    if (!v1 || !v2) return
